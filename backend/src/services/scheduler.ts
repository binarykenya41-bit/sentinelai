...
import { syncNvdLatest, syncKev, syncVulDb, syncAll } from "./cve-sync.js"
...
export const schedulerState = {
  nvd:     { lastRun: null as string | null, lastResult: null as unknown },
  kev:     { lastRun: null as string | null, lastResult: null as unknown },
  vuldb:   { lastRun: null as string | null, lastResult: null as unknown },
  autoSim: { lastRun: null as string | null, lastResult: null as unknown },
  mitre:   { lastRun: null as string | null, lastResult: null as unknown },
  running: false,
}
...
export function startScheduler(): void {
  ...
  setImmediate(() => {
    ...
    safe("mitre-startup-warm", async () => {
      ...
      schedulerState.mitre.lastRun = new Date().toISOString()
      schedulerState.mitre.lastResult = result
      console.log(`[SCHEDULER] MITRE cache warm: ${(result as { techniques: number }).techniques} techniques loaded`)
    })()
  })
