...
export async function darkWebRoutes(app: FastifyInstance) {
  app.get<{ Querystring: { category?: string; severity?: string; status?: string; limit?: string } }>(
    "/api/dark-web", async (req, reply) => {
  ...
  app.get<{ Params: { id: string } }>("/api/dark-web/:id", async (req, reply) => {
  ...
  app.patch<{ Params: { id: string }; Body: { status?: string } }>(
    "/api/dark-web/:id", async (req, reply) => {
