...
import { getAdminActivityLogs, getVpcFirewallLogs, getAuthFailureLogs, getGkeLogs, getSecurityLogs, } from "../integrations/gcp/logging.js";
import { getSccFindings, getCveFindingsFromScc, summarizeSccFindings } from "../integrations/gcp/scc.js";
export async function gcpRoutes(app) {
    ...
    app.post("/api/gcp/compute/sync", async (req, reply) => {
