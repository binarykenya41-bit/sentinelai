...
export async function dashboardRoutes(app) {
    ...
    app.get("/api/dashboard/stats", async (_req, reply) => {
        ...
        const exploitable = vulns.filter((v) => (v.epss_score ?? 0) >= 0.7 && v.remediation_status === "open");
    ...
    app.get("/api/dashboard/activity", async (req, reply) => {
